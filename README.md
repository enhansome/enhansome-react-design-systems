...
* [Ant Design](https://ant.design/) \[[github](https://github.com/ant-design/ant-design/) ⭐ 99,346 | 🐛 1,103 | 🌐 TypeScript | 📅 2026-09-01] - Ant Financial - A design system with values of Nature and Determinacy for better user experience of enterprise applications.
* [Material UI](https://www.material-ui.com/#/) \[[github](https://github.com/mui-org/material-ui) ⭐ 98,982 | 🐛 1,483 | 🌐 JavaScript | 📅 2026-09-01] - Google - React components that implement Google's Material Design.
* [Blueprint](http://blueprintjs.com/) \[[github](https://github.com/palantir/blueprint) ⭐ 22,021 | 🐛 941 | 🌐 TypeScript | 📅 2026-09-01] - Palantir - A React-based UI toolkit for the web
* [Carbon Design System](http://carbondesignsystem.com/) \[[github](https://github.com/carbon-design-system/carbon-components) ⭐ 9,398 | 🐛 1,011 | 🌐 JavaScript | 📅 2026-09-01] - IBM - The Carbon Design System is integrating the new IBM Design Ethos and Language.
* [Grommet](http://grommet.io/) \[[github](https://github.com/grommet/grommet) ⭐ 8,353 | 🐛 472 | 🌐 JavaScript | 📅 2026-09-01] - Hewlett Packard - Grommet provides all the guidance, components, and design resources you need to take your ideas from concept to a real application.
...
* [Ring UI](http://www.jetbrains.org/ring-ui/index.html) \[[github](https://github.com/JetBrains/ring-ui) ⭐ 3,788 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-01] - JetBrains - This collection of UI components aims to provide all of the necessary building
...
* [Garden](https://garden.zendesk.com/react-components/) \[[github](https://github.com/zendeskgarden/react-components) ⭐ 1,111 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-01] - Zendesk Garden - our curated collection of UI goodness.
...
* [SpareBank 1's Design System](https://design.sparebank1.no/) \[[github](https://github.com/SpareBank1/designsystem) ⭐ 115 | 🐛 113 | 🌐 TypeScript | 📅 2026-09-01] - SpareBank - A common language across disciplines, to ensure consistent design in our solutions.
